...
class DetectObjectScreen extends StatefulWidget {
  static String routeName = "/detectObject_screen";
...
class _DetectObjectScreenState extends State<DetectObjectScreen> {
  ...
  loadModel() async {
    await Tflite.loadModel(
        model: "assets/ml/model_object.tflite", labels: "assets/ml/labels_object.txt");
  }
  ...
  speakOutput(String? output) {
    if (output == '0 Fire') {
      _speak("There is a fire in front of you");
      _stop();
    } else if (output == '1 people') {
      _speak("There is a person in front of you");
      _stop();
    } else if (output == '2 holes') {
      _speak("There is a hole in front of you");
      _stop();
    } else if (output == '3 Cars') {
      _speak("There is a car in front of you");
      _stop();
    }else {
      _speak("Can't detect any object");
    }
  }
